      ...
      <div className='bg-white w-full max-w-md rounded overflow-hidden p-4 mx-auto'>
        ...
        <form action="" className='grid gap-4 mt-5' onSubmit={handleSubmit}>
          <div className='flex flex-col gap-1'>
            ...
            <input type="text" id='name' name='name' placeholder='enter your name' className='bg-slate-100 px-2 py-1 focus:outline-[#00acb4]' value={data.name} onChange={handleOnChange} required />
          </div>
          ...
          <div className='flex flex-col gap-1'>
            ...
            <input type="password" id='password' name='password' placeholder='enter your password' className='bg-slate-100 px-2 py-1 focus:outline-[#00acb4]' value={data.password} onChange={handleOnChange} required />
          </div>

          <div className='flex flex-col gap-1'>
            <label htmlFor="profile_pic">Photo

              <div className='h-14 bg-slate-200 flex justify-center items-center border border-slate-200 rounded hover:border-[#00acb4] cursor-pointer'>
