  ...
  return (
    <div style={{backgroundImage: `url(${backgroundImage})`}} className='bg-no-repeat bg-cover'>
      <header className='sticky top-0 h-16 bg-white flex justify-between items-center px-4'>
        <div className='flex items-center gap-4'>
          ...
          <div>
            ...
            <p className='-my-2 text-sm'>
              {
                dataUser.online ? <span className='text-[#00acb4]'>online</span> : <span className='text-slate-400'>offline</span>
              }
            </p>
          </div>
        </div>
        ...
        <div>
          <button className='cursor-pointer hover:text-[#00acb4]'><HiDotsVertical/></button>
        </div>
      </header>
      ...
      <section className='h-16 bg-white flex items-center px-4'>
        <div className='relative'>
          <button onClick={handleUploadImageVideoOpen} className='flex justify-center items-center w-11 h-11 rounded-full hover:bg-[#00acb4] hover:text-white'>
            <FaPlus size={20}/>
          </button>
        ...
        <form action="" className='h-full w-full flex gap-2' onSubmit={handleSendMessage}>
          ...
          <button className='text-[#00acb4] hover:text-[#058187]'>
            <IoMdSend size={28}/>
          </button>
        </form>
      </section>
